    ...
    public partial class newrecords : Form
    {
        ...
        void add_newstudent()
        {
            ...
            try
            {
                ...
                {
                    MySqlCommand cmdDataBase = new MySqlCommand("insert into internals.student (RollNo,Fname,Lname,Email,ProgramCode,Batch,GroupName,ContactNo,CollegeCode) values('" + this.dataGridView1.Rows[i].Cells[0].Value + "','" + this.dataGridView1.Rows[i].Cells[1].Value + "','" + this.dataGridView1.Rows[i].Cells[2].Value + "','" + this.dataGridView1.Rows[i].Cells[3].Value + "','" + this.dataGridView1.Rows[i].Cells[4].Value + "','" + this.dataGridView1.Rows[i].Cells[5].Value + "','" + this.dataGridView1.Rows[i].Cells[6].Value + "','" + this.dataGridView1.Rows[i].Cells[7].Value + "','" + this.dataGridView1.Rows[i].Cells[8].Value + "')", conDataBase);
