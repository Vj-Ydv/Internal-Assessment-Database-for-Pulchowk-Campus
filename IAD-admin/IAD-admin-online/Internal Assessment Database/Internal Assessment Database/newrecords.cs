    ...
    public partial class newrecords : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                for (i = 1; i < rcount; i++)
                {
                    ...
                    dataGridView1.Rows.Add(worksheet.Cells[i + 1, 1].Value, worksheet.Cells[i + 1, 2].Value, worksheet.Cells[i + 1,3].Value, worksheet.Cells[i + 1, 4].Value, worksheet.Cells[i + 1, 5].Value, worksheet.Cells[i + 1, 6].Value);
                }
        ...
        void add_newstudent()
        {
            ...
            try
            {
                ...
                {
                    MySqlCommand cmdDataBase = new MySqlCommand("insert into internals.student (RollNo,Fname,MiddleName,Lname,Email,ProgramCode,Batch,GroupName,ContactNo,CollegeCode) values('" + this.dataGridView1.Rows[i].Cells[0].Value + "','" + this.dataGridView1.Rows[i].Cells[1].Value + "','" + this.dataGridView1.Rows[i].Cells[2].Value + "','" + this.dataGridView1.Rows[i].Cells[3].Value + "','"+this.dataGridView1.Rows[i].Cells[4].Value+"','" + this.comboBox2.Text + "','" + this.comboBox3.Text + "','" + this.comboBox4.Text + "','" + this.dataGridView1.Rows[i].Cells[5].Value + "','" + this.comboBox1.Text + "')", conDataBase);
                    MySqlDataReader myReader;
                    try
                    {
                        conDataBase.Open();
        ...
        void update_newstudent()
        {
            ...
            try
            {
                for (int i = 0; i < dataGridView1.Rows.Count - 1; i++)
                {
                    String constring = "SERVER=db4free.net;UID=internals;PWD=peaceinheaven;PORT=3306;DATABASE=internals;old guids=true";
                    MySqlConnection conDataBase = new MySqlConnection(constring);
                    MySqlCommand cmdDataBase = new MySqlCommand("update internals.student set Fname='" + this.dataGridView1.Rows[i].Cells[1].Value + "',MiddleName='" + this.dataGridView1.Rows[i].Cells[2].Value + "',Lname='" + this.dataGridView1.Rows[i].Cells[3].Value + "',Email='" + this.dataGridView1.Rows[i].Cells[4].Value + "',ContactNo='" + this.dataGridView1.Rows[i].Cells[5].Value + "' where RollNo='" + this.dataGridView1.Rows[i].Cells[0].Value + "';", conDataBase);
                    MySqlDataReader myReader;
                    try
                    {
                        conDataBase.Open();
        ...
        private void panel1_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            label13.ForeColor = Color.FromArgb(temp1.R, temp1.G, temp1.B);
        }
        ...
        private void label7_Click(object sender, EventArgs e)
        {
            ...
            dataGridView1.Columns.Add("column3", "College Code");
        ...
        private void label3_Click(object sender, EventArgs e)
        {
            ...
            dataGridView1.Columns.Add("column2", "MiddleName");
            dataGridView1.Columns.Add("column3", "Lname");
        ...
        void update_password()
        {
            ...
            String constring = "SERVER=db4free.net;UID=internals;PWD=peaceinheaven;PORT=3306;DATABASE=internals;old guids=true";
            MySqlConnection conDataBase = new MySqlConnection(constring);
            MySqlCommand cmdDataBase = new MySqlCommand("update internals.login set Password=aes_encrypt('" +dataGridView1.Rows[0].Cells[2].Value+ "','SecretKey') where UserName='" + this.dataGridView1.Rows[0].Cells[0].Value + "' and CollegeCode='"+ this.dataGridView1.Rows[0].Cells[1].Value + "';", conDataBase);
            MySqlDataReader myReader;
            try
            {
                conDataBase.Open();
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            String constring = "SERVER=db4free.net;UID=internals;PWD=peaceinheaven;PORT=3306;DATABASE=internals;old guids=true";
            MySqlConnection conDataBase = new MySqlConnection(constring);
            MySqlCommand cmdDataBase = new MySqlCommand("select UserName,cast(aes_decrypt(Password,'SecretKey') as char(50)) as Password,CollegeCode from internals.login where UserName='" + this.dataGridView1.Rows[0].Cells[0].Value + "' and CollegeCode='"+dataGridView1.Rows[0].Cells[1].Value+"';", conDataBase);
        ...
        private void button7_Click_1(object sender, EventArgs e)
        {
            ...
            String constring = "SERVER=db4free.net;UID=internals;PWD=peaceinheaven;PORT=3306;DATABASE=internals;old guids=true";
            MySqlConnection conDataBase = new MySqlConnection(constring);
            MySqlCommand cmdDataBase = new MySqlCommand("select s.RollNo,s.Fname,s.MiddleName,s.Lname,s.Email,s.ContactNo from internals.student s where CollegeCode='" + comboBox1.Text + "' and s.ProgramCode='" + comboBox2.Text + "' and s.Batch='" + comboBox3.Text + "' and s.GroupName='" + comboBox4.Text + "';", conDataBase);
            try
            {
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                for (int i = 0; i < dataGridView1.Rows.Count - 1; i++)
                {
                    MySqlCommand cmdDataBase = new MySqlCommand("insert into internals.login (CollegeCode,UserName,Password) values('" + this.dataGridView1.Rows[i].Cells[0].Value + "','" + this.dataGridView1.Rows[i].Cells[1].Value + "',aes_encrypt('" + this.dataGridView1.Rows[i].Cells[2].Value + "','SecretKey'));", conDataBase);
                    MySqlDataReader myReader;
                    try
                    {
                        conDataBase.Open();
        ...
        private void label13_Click(object sender, EventArgs e)
        {
            ...
            dataGridView1.Columns.Add("column0", "College Code");
            dataGridView1.Columns.Add("column1", "New Username");
            dataGridView1.Columns.Add("column1", "New Password");
            label1.Text = label6.Text;
            panel9.Visible = true;
        ...
        void delete_account()
        {
            ...
            try
            {
                MySqlCommand cmdDataBase = new MySqlCommand("delete from internals.login where UserName='" + this.dataGridView1.Rows[0].Cells[0].Value + "' and CollegeCode='" + this.dataGridView1.Rows[0].Cells[1].Value + "';", conDataBase);
                    MySqlDataReader myReader;
                    try
                    {
                        conDataBase.Open();
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show("Account with given Username and CollegeCode doesnot exists.");
                }
                conDataBase.Close();
            }
            catch (Exception ex)
